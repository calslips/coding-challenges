...
of on bits '2' but the integer 10 is less than 12 so it comes first in
sorted order.
...
Note:
Your function should modify the input rather than creating a new array.
...
// function sortByBit(arr) {
//   return arr.sort((a, b) => {
//     const aOn = [...a.toString(2)].filter(e => +e).length, bOn = [...b.toString(2)].filter(e => +e).length;
//     if (aOn < bOn) return -1;
//     else if (aOn > bOn) return 1;
//     else return a - b;
//   });
// }