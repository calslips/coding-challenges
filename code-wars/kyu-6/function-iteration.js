 ...
 *The purpose of this kata is to write a higher-order function returning
 a new function that iterates on a specified function a given number of
 times. This new function takes in an argument as a seed to start the
 computation from.
...
var createIterator = function (func, n) {
  return a => Array(n).fill(func).reduce((x, f) => f(x), a);
};