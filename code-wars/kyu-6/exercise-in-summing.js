/**
 * Your task is to finish two functions,
 * minimumSum and maximumSum, that take 2 parameters:
...
All values given to the functions will be integers.

Also take care of the following special cases:
...
function minimumSum(values, n) {
  values.sort((a, b) => a - b);
  return values.slice(0, n).reduce((s, n) => s + n, 0);
}
