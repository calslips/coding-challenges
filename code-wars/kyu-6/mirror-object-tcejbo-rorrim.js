...
"You cannot change the original object, because if you did that the
reflection would change."
 */

const mirror = obj => Object.keys(obj).reduce((o, k) => (o[k] = [...k].reverse().join('')) && o, {});