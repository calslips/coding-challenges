...
has not provided the relevant details (marked with a null value in JavaScript,
  with the default value in COBOL). The value of the question property should be
...
function askForMissingDetails(list) {
  return list.filter(d => Object.keys(d).some(e => !d[e] && (d.question = `Hi, could you please provide your ${e}.`)));
}

// function askForMissingDetails(list) {
//   return list.reduce((p, c) => Object.values(c).includes(null) ? p.concat(c) : p, [])
//     .map(d => ({...d, 'question': `Hi, could you please provide your ${Object.entries(d).find(e => e[1] === null)[0]}.`}));
// }