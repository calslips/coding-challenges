...
To help you get started, here is an excerpt from Wikipedia's page on
Ordinal Indicators:
...
11, 12 or 13 use -th (e.g. 11th, pronounced eleventh, 112th, pronounced
...
function numberToOrdinal(n) {
  switch (true) {
    case !n:
      return `${n}`;
    case `${n}`.endsWith('11') || `${n}`.endsWith('12') || `${n}`.endsWith('13'):
      return `${n}th`;
    case `${n}`.endsWith('1'):
      return `${n}st`;
    case `${n}`.endsWith('2'):
