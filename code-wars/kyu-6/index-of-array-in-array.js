 ...
 *JavaScript's indexOf does not work with arrays as input. This is because
 [1,2] === [1,2] will return false in JavaScript. Many other languages have
 similar quirks.

However, sometimes it is useful to search for an Array. Write a function
that looks for an array within a two-dimensional array and returns the index
of the first matching element. If there is no match, your function should
return -1.
...
var searchArray = function (arrayToSearch, query) {
  if (
    ...
    arrayToSearch.some(e => !Array.isArray(e) || e.length !== 2) ||
    query.length !== 2
  ) throw Error('Invalid input(s)');
  return arrayToSearch.findIndex(a => a[0] === query[0] && a[1] === query[1]);
}