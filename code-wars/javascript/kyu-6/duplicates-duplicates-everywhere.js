...
numerically, and the larger key will keep that character. That's why in
the example above the array under the key "2" contains "A" and "B",
as 2 > 1.
If duplicate characters are found in the same array, the first occurance
should be kept.
...
const removeDuplicateIds = (obj) => {
  return Object.entries(obj).reduceRight((a, [p, v]) => (obj[p] = [...new Set(v)].filter(e => !a.includes(e))) && a.concat(v), []) && obj;
};