/**
 * Note: This kata is a translation of this (Java) one:
 * http://www.codewars.com/kata/rotate-array. I have not translated this
 * first one as usual because I did not solved it, and I fear not being
 * able to solve it (Java is not my cup of... tea). @cjmcgraw, if you want
 * to use my translation on your kata feel free to use it.
...
function rotate(a, n) {
  const copy = a.slice();
  for (let i = Math.abs(n % a.length); i; i--) n > 0 ? copy.unshift(copy.pop()) : copy.push(copy.shift());
  return copy;
}