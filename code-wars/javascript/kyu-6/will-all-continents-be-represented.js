...
The input array and continent names will always be valid and formatted
as in the list above for example 'Africa' will always start with upper-case 'A'.
 */
...
function allContinents(list) {
  ...
  list.forEach(e => continents[e.continent]++);
  return Object.values(continents).every(n => n)
}