/**
 * Write a function evilTwin(obj) which returns a new object with all the
 * same properties as obj, and with an additional property hasGoatee set
 * to true.
...
function evilTwin(obj) {
  return ((evil = Object.create(obj)) && (evil.hasGoatee = true)) && evil;
}