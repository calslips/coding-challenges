/**
 * A friend of yours is developing an application for a hotel. You should
 * write a function that returns all names of the people on a given floor.
...
corresponds to the room-number and holds the name of the client.
...
Floors are numbered starting at 1.
...
and function roomMates( rooms, 2 ) should return ["Jimmy", "Tom", "Duke"].
 */

function roomMates( rooms, floor ) {
  return rooms.filter((e, i) => e && floor === Math.floor(i / 6 + 1));
}
