...
Parameters: an object containing gunners as keys and their associated response as values
Returns:
  if ALL gunners are ready, return 'Fire!'
  if even one gunner is NOT ready, return 'Shiver me timbers!'
Examples:
...
Pseudocode:
  convert input to an array of values
  check if every elements value equates to 'aye'
    if so, return 'Fire!'
