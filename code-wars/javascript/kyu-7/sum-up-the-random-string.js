...
All the numbers should be treaded as positive integer. eg, 11-14 should be
treated as two numbers 11 and 14. Same as 3.14, should be treated as two
numbers 3 and 14
...
function sumFromString(str) {
  let result = 0, n = '';
  for (let c of str) !isNaN(+c) ? n += c : (result += +n, n = '');
  return result += +n;
}