/*
We need to write some code to return the original price of a
product, the return type must be of type decimal and the number
...
applying the sale percentage, which is ($100.00) of course,
rounded to two decimal places.

DiscoverOriginalPrice(75, 25) => 100.00M
  where 75 is the sale price (discounted price),
  25 is the sale percentage and 100 is the original price

Parameters: 2 nums (sale price & discount)
Returns: a num (original price to 2 decimal places)
Examples:
  discoverOriginalPrice(75, 25), 100
  discoverOriginalPrice(25, 75), 100
  discoverOriginalPrice(75.75, 25), 101
Pseudocode:
  divide sale price by 1 subtracted by discount divided by 100
