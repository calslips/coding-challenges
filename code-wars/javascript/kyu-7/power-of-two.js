...
Complete the function power_of_two/powerOfTwo (or equivalent,
  ...
  non-negative integer is a power of two. From the
  corresponding Wikipedia entry:

a power of two is a number of the form 2n where n is an integer,
i.e. the result of exponentiation with number two as the base
...
Parameters: a num
Returns: a boolean
  whether input num is a power of two
Examples:
  isPowerOfTwo(2), true
  isPowerOfTwo(4096), true
  isPowerOfTwo(5), false
Pseudocode:
  if the result of the input passed into Math log2 method is an int
    return true
  otherwise
    return false
*/
