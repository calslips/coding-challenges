 ...
 * value equal to its position in the alphabet, our string will have a value
 * of 1 + 2 + 3 = 6. This means that: a = 1, b = 2, c = 3 ....z = 26.

You will be given a list of strings and your task will be to return the values
of the strings as explained above multiplied by the position of that string in
the list. For our purpose, position begins with 1.
...
function wordValue(a) {
  return a.map((w, i) => [...w].reduce((s, c) => c === ' ' ? s : s + c.charCodeAt() - 96, 0) * (i + 1));
}