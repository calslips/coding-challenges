...
Task
Create function union getting 2 sets as arguments and returning
a new Set as result of union of these 2 sets.
...
Examples:
  let A = new Set([5, 6, 7]);
  let B = new Set([7, 8, 9]);
  union(A, B), new Set([5, 6, 7, 8, 9]);
Pseudocode:
  return a new set initialized with
    set1 and set2 spread into an array passed in
*/
