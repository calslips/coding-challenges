 ...
 * by the fact that everyone constantly wants to have a meeting with you, and
 * that the meeting rooms are always taken!
...
function meeting(x) {
  return x.includes('O') ? x.findIndex(r => r === 'O') : 'None available!';
}