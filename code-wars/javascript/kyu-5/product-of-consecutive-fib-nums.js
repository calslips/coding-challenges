...
Your function productFib takes an integer (prod) and returns an
array:

[F(n), F(n+1), true] or {F(n), F(n+1), 1} or (F(n), F(n+1), True)
depending on the language if F(n) * F(n+1) = prod.

If you don't find two consecutive F(n) verifying F(n) * F(n+1) =
prodyou will return
...
productFib(800) # should return (34, 55, false),
                # since F(8) = 21, F(9) = 34, F(10) = 55 and
                  21 * 34 < 800 < 34 * 55
-----
productFib(714) # should return [21, 34, true],
productFib(800) # should return [34, 55, false],
...
Pseudocode:
  initialize vars a, b using destructured assignment a is 0, b is 1
  create a loop to run as long as a times b is less than input num
    reassign a to equal b, and b to equal a + b
  return an array containing a, b, and if a * b equals input num
*/
