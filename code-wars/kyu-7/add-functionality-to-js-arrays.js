/**
 * The JavaScript standard now includes functional additions to array like
 * map, filter and reduce, but sadly is missing the convenience functions
 * range and sum . Implement a version of range and sum (which you can then
 * copy and use in your future Kata to make them smaller).
