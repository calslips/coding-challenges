...
all listeners. Names should be treated in a case-insensitive manner, i.e. "John"
is the same as "john".
...
class Song {
  ...
  howMany(a) {
    const newList = [...new Set(this.listeners.concat(a.map(l => l.toLowerCase())))];
    const newListenerCount = newList.length - this.listeners.length;
...
//   howMany(a) {
//     let oldList = this.listeners.size;
//     a.forEach(l => this.listeners.add(l.toLowerCase()));
//     return this.listeners.size - oldList;
//   }
// }