/**
 *Remember the spongebob meme that is meant to make fun of people by
 repeating what they say in a mocking way?
...
function spongeMeme(sentence) {
  return [...sentence].map((c, i) => i % 2 ? c.toLowerCase() : c.toUpperCase()).join('');
}