...
Explanation:
Since , {-282 , 818 , 900 , 928 } is the even numbers here , So it came first in
ascending order , then the odds in descending order { 281 , 49 , -1 }
...
function menFromBoys(arr) {
  ...
  for (let i = 0; i < arr.length; i++) {
    arr[i] % 2 ? odds.unshift(arr[i]) : evens.push(arr[i]);
  }
